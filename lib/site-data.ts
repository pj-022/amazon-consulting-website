...
export const brandThemes = {
  coral: {
    ...
    ring: "ring-accent/20",
    surface: "bg-accent/8",
    surfaceBorder: "border-accent/25",
  },
  sky: {
    accent: "text-navy",
    value: "text-navy",
    ...
    ring: "ring-navy/20",
    surface: "bg-navy/8",
    surfaceBorder: "border-navy/25",
  },
  violet: {
    accent: "text-[var(--brand-violet)]",
    value: "text-[var(--brand-violet)]",
    border: "border-l-[var(--brand-violet)]",
    dot: "bg-[var(--brand-violet)]",
    ring: "ring-[var(--brand-violet)]/20",
    surface: "bg-[var(--brand-violet)]/10",
    surfaceBorder: "border-[var(--brand-violet)]/25",
  },
  mint: {
    accent: "text-sage",
    value: "text-sage",
  ...
  rose: {
    accent: "text-[var(--brand-rose)]",
    value: "text-[var(--brand-rose)]",
    border: "border-l-[var(--brand-rose)]",
    dot: "bg-[var(--brand-rose)]",
    ring: "ring-[var(--brand-rose)]/20",
    surface: "bg-[var(--brand-rose)]/10",
    surfaceBorder: "border-[var(--brand-rose)]/25",
  },
} as const;
